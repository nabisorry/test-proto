...
goog.exportSymbol('proto.jobs.ClinentMessage', null, global);
 ...
 * @constructor
 */
proto.jobs.ClinentMessage = function (opt_data) {
    jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.jobs.ClinentMessage, jspb.Message);
if (goog.DEBUG && !COMPILED) {
    /**
     * @public
     * @override
     */
    proto.jobs.ClinentMessage.displayName = 'proto.jobs.ClinentMessage';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (jspb.Message.GENERATE_TO_OBJECT) {
     ...
     * @return {!Object}
     */
    proto.jobs.ClinentMessage.prototype.toObject = function (opt_includeInstance) {
        return proto.jobs.ClinentMessage.toObject(opt_includeInstance, this);
    };
    /**
     ...
     *     http://goto/soy-param-migration
     * @param {!proto.jobs.ClinentMessage} msg The msg instance to transform.
     * @return {!Object}
     * @suppress {unusedLocalVariables} f is only used for nested messages
     */
    proto.jobs.ClinentMessage.toObject = function (includeInstance, msg) {
        var f, obj = {
 ...
 * @return {!proto.jobs.ClinentMessage}
 */
proto.jobs.ClinentMessage.deserializeBinary = function (bytes) {
    var reader = new jspb.BinaryReader(bytes);
    var msg = new proto.jobs.ClinentMessage;
    return proto.jobs.ClinentMessage.deserializeBinaryFromReader(msg, reader);
};
/**
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.jobs.ClinentMessage} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.jobs.ClinentMessage}
 */
proto.jobs.ClinentMessage.deserializeBinaryFromReader = function (msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.jobs.ClinentMessage.prototype.serializeBinary = function () {
    var writer = new jspb.BinaryWriter();
    proto.jobs.ClinentMessage.serializeBinaryToWriter(this, writer);
    return writer.getResultBuffer();
};
/**
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.jobs.ClinentMessage} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.jobs.ClinentMessage.serializeBinaryToWriter = function (message, writer) {
    var f = undefined;
 ...
 * @return {string}
 */
proto.jobs.ClinentMessage.prototype.getMessage = function () {
    return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
/**
 * @param {string} value
 * @return {!proto.jobs.ClinentMessage} returns this
 */
proto.jobs.ClinentMessage.prototype.setMessage = function (value) {
